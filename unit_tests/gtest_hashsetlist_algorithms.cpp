...
class HashSetListAlgorithmsTest : public ::testing::Test
{
  public:
	HashSetListAlgorithmsTest()
	    : hashset_(Capacity) {}
...
TEST_F(HashSetListAlgorithmsTest, Minimum)
{
...
TEST_F(HashSetListAlgorithmsTest, Maximum)
{
...
TEST_F(HashSetListAlgorithmsTest, AllOfGreater)
{
...
TEST_F(HashSetListAlgorithmsTest, NoneOfGreater)
{
...
TEST_F(HashSetListAlgorithmsTest, AnyOfGreater)
{
...
TEST_F(HashSetListAlgorithmsTest, CountEqual)
{
...
TEST_F(HashSetListAlgorithmsTest, CountElementsGreater)
{
...
TEST_F(HashSetListAlgorithmsTest, DistanceToFirstElementEqual)
{
...
TEST_F(HashSetListAlgorithmsTest, DistanceToFirstElementBigger)
{
...
TEST_F(HashSetListAlgorithmsTest, DistanceToFirstElementNotBigger)
{
...
TEST_F(HashSetListAlgorithmsTest, CheckEqual)
{
