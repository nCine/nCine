...
class HashSetListMovableTest : public ::testing::Test
{
  ...
  protected:
	nctl::HashSetList<Movable, nctl::FNV1aFuncHashContainer<Movable>> hashset_;
};
...
TEST_F(HashSetListMovableTest, MoveConstruction)
{
	...
	nctl::HashSetList<Movable, nctl::FNV1aFuncHashContainer<Movable>> newHashset(nctl::move(hashset_));
...
TEST_F(HashSetListMovableTest, MoveAssignmentOperator)
{
	...
	nctl::HashSetList<Movable, nctl::FNV1aFuncHashContainer<Movable>> newHashset(Capacity);
