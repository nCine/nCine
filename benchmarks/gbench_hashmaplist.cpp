...
using SaxHashMap = nctl::HashMapList<unsigned int, unsigned int, nctl::deprecated::SaxHashFunc<unsigned int>>;
using JenkinsHashMap = nctl::HashMapList<unsigned int, unsigned int, nctl::deprecated::JenkinsHashFunc<unsigned int>>;
using FNV1aHashMap = nctl::HashMapList<unsigned int, unsigned int, nctl::deprecated::FNV1aHashFunc<unsigned int>>;
using FastHashMap = nctl::HashMapList<unsigned int, unsigned int, nctl::FastHashFunc<unsigned int>>;
