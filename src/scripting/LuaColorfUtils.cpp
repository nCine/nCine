...
void LuaColorfUtils::push(lua_State *L, const Colorf &color)
{
...
void LuaColorfUtils::pushField(lua_State *L, const char *name, const Colorf &color)
{
	push(L, color);
	LuaUtils::setField(L, -2, name);
}

Colorf LuaColorfUtils::retrieve(lua_State *L, int index, int &newIndex)
{
...
Colorf LuaColorfUtils::retrieveTable(lua_State *L, int index)
{
...
Colorf LuaColorfUtils::retrieveArray(lua_State *L, int index)
{
...
Colorf LuaColorfUtils::retrieveParams(lua_State *L, int index)
{
...
Colorf LuaColorfUtils::retrieveTableField(lua_State *L, int index, const char *name)
{
...
Colorf LuaColorfUtils::retrieveArrayField(lua_State *L, int index, const char *name)
{
	LuaUtils::retrieveFieldTable(L, index, name);
