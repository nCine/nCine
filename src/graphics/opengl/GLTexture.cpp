...
GLTexture::GLTexture(GLenum target)
    : glHandle_(0), target_(target), textureUnit_(0), imageFormat_(GL_RGBA8)
{
...
void GLTexture::texImage2D(GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLenum format, GLenum type, void* data)
{
    bind();
...
void GLTexture::texSubImage2D(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, void* data)
{
    bind();
