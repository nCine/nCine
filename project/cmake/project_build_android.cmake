if(NCPROJECT_BUILD_ANDROID)
	...
	set(ANDROID_PASSTHROUGH_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DNCINE_DYNAMIC_LIBRARY=${NCINE_DYNAMIC_LIBRARY}
		-DEXTERNAL_ANDROID_DIR=${NCINE_EXTERNAL_ANDROID_DIR} -DGENERATED_INCLUDE_DIR=${GENERATED_INCLUDE_DIR}
		-DNCPROJECT_STRIP_BINARIES=${NCPROJECT_STRIP_BINARIES} -DNCPROJECT_ROOT=${NCPROJECT_ROOT}
		-DNCPROJECT_SOURCE_DIR=${CMAKE_SOURCE_DIR} -DNCPROJECT_BINARY_DIR=${CMAKE_BINARY_DIR}
		-DNCPROJECT_WITH_CRASHPAD=${NCPROJECT_WITH_CRASHPAD})
	...
	if(NCINE_WITH_CRASHPAD AND NCPROJECT_WITH_CRASHPAD)
	...
	if(EXISTS ${NCINE_ANDROID_DIR}/app/src/main/cpp/ncine/private_include)
		file(COPY ${NCINE_ANDROID_DIR}/app/src/main/cpp/ncine/private_include DESTINATION android/app/src/main/cpp/ncine/)
	endif()
	...
	if(NCPROJECT_WITH_CRASHPAD)
		foreach(ARCHITECTURE ${NCPROJECT_NDK_ARCHITECTURES})
			find_program(ANDROID_CRASHPAD_HANDLER
				NAMES libcrashpad_handler.so
				PATHS ${NCINE_ANDROID_NCINE_LIB_DIR} ${NCINE_ANDROID_DIR}/app/build/ncine/
			...
			if (EXISTS ${ANDROID_CRASHPAD_HANDLER})
				...
				add_custom_target(ncproject_android_crashpad_handler_${ARCHITECTURE} DEPENDS ${ANDROID_CRASHPAD_HANDLER_DEST_BINARY_DIR}/libcrashpad_handler.so)
				set_target_properties(ncproject_android_crashpad_handler_${ARCHITECTURE} PROPERTIES FOLDER "Android")
				add_dependencies(ncproject_android ncproject_android_crashpad_handler_${ARCHITECTURE})
			endif()
		endforeach()
	endif()
