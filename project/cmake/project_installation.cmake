...
if(MSVC OR APPLE OR EMSCRIPTEN)
	...
	set(README_INSTALL_DESTINATION share/${NCPROJECT_LOWER_NAME})
...
if(MSVC)
	...
	set(CPACK_NSIS_MUI_ICON "${NCPROJECT_DATA_DIR}/icons/icon.ico")
...
elseif(APPLE)
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -E copy_if_different ${NCPROJECT_DATA_DIR}/icons/icon1024.png ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_512x512@2x.png
		COMMAND sips -z 512 512 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_512x512.png
		...
		COMMAND sips -z 256 256 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_256x256.png
		...
		COMMAND sips -z 128 128 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_128x128.png
		COMMAND sips -z 64 64 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_32x32@2x.png
		COMMAND sips -z 32 32 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_32x32.png
		...
		COMMAND sips -z 16 16 ${NCPROJECT_DATA_DIR}/icons/icon1024.png --out ${CMAKE_BINARY_DIR}/${CPACK_BUNDLE_NAME}.iconset/icon_16x16.png
...
elseif(UNIX AND NOT APPLE)
	...
	if(EXISTS ${NCPROJECT_DATA_DIR}/icons)
		install(FILES ${NCPROJECT_DATA_DIR}/icons/icon1024.png DESTINATION ${ICONS_INSTALL_DESTINATION}/1024x1024/apps/ RENAME ${NCPROJECT_NAME}.png)
		install(FILES ${NCPROJECT_DATA_DIR}/icons/icon192.png DESTINATION ${ICONS_INSTALL_DESTINATION}/192x192/apps/ RENAME ${NCPROJECT_NAME}.png)
		install(FILES ${NCPROJECT_DATA_DIR}/icons/icon96.png DESTINATION ${ICONS_INSTALL_DESTINATION}/96x96/apps/ RENAME ${NCPROJECT_NAME}.png)
		install(FILES ${NCPROJECT_DATA_DIR}/icons/icon72.png DESTINATION ${ICONS_INSTALL_DESTINATION}/72x72/apps/ RENAME ${NCPROJECT_NAME}.png)
		install(FILES ${NCPROJECT_DATA_DIR}/icons/icon48.png DESTINATION ${ICONS_INSTALL_DESTINATION}/48x48/apps/ RENAME ${NCPROJECT_NAME}.png)
	endif()
