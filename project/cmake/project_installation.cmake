...
if(MSVC OR INSTALL_LIBRARIES_MINGW)
	...
	if(EXISTS ${NCINE_CONFIG_H})
		...
		if(SDL3_FOUND AND NCINE_WITH_SDL3)
			...
			install(FILES ${SDL3_IMPORTED_LOCATION} DESTINATION ${RUNTIME_INSTALL_DESTINATION})
		endif()
		...
		if(INSTALL_LIBRARIES_MINGW)
			install(DIRECTORY ${NCINE_EXTERNAL_DIR}/bin/ DESTINATION ${RUNTIME_INSTALL_DESTINATION} FILES_MATCHING PATTERN "*.dll")
		else()
	...
	if(INSTALL_LIBRARIES_MINGW)
		install(FILES ${MINGW_SYSTEMLIB_LOCATIONS} DESTINATION ${RUNTIME_INSTALL_DESTINATION})
	endif()
elseif(LINUX AND NOT CMAKE_SKIP_RPATH AND NOT CMAKE_SKIP_INSTALL_RPATH)
	...
	set_target_properties(${NCPROJECT_EXE_NAME} PROPERTIES INSTALL_RPATH "$ORIGIN;$ORIGIN/../${LIBRARY_INSTALL_DESTINATION}")
...
elseif(APPLE)
	...
	if(EXISTS ${NCINE_CONFIG_H})
		...
		if(IS_DIRECTORY ${FRAMEWORKS_DIR}/sdl3.framework AND NCINE_WITH_SDL3)
			install(DIRECTORY ${FRAMEWORKS_DIR}/sdl3.framework DESTINATION ${FRAMEWORKS_INSTALL_DESTINATION})
		endif()
		if(IS_DIRECTORY ${FRAMEWORKS_DIR}/sdl3.framework AND NCINE_WITH_SDL3)
			install(DIRECTORY ${FRAMEWORKS_DIR}/sdl3.framework DESTINATION ${FRAMEWORKS_INSTALL_DESTINATION})
		endif()
		if(IS_DIRECTORY ${FRAMEWORKS_DIR}/sdl2.framework AND NCINE_WITH_SDL2)
