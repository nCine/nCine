...
elseif(UNIX AND NOT APPLE)
	...
	if(EXISTS ${NCPROJECT_ICONS_DIR}/icon1024.png)
		install(FILES ${NCPROJECT_ICONS_DIR}/icon1024.png DESTINATION ${ICONS_INSTALL_DESTINATION}/1024x1024/apps/ RENAME ${NCPROJECT_NAME}.png COMPONENT data)
	endif()
	if(EXISTS ${NCPROJECT_ICONS_DIR}/icon192.png)
		install(FILES ${NCPROJECT_ICONS_DIR}/icon192.png DESTINATION ${ICONS_INSTALL_DESTINATION}/192x192/apps/ RENAME ${NCPROJECT_NAME}.png COMPONENT data)
	endif()
	if(EXISTS ${NCPROJECT_ICONS_DIR}/icon96.png)
		install(FILES ${NCPROJECT_ICONS_DIR}/icon96.png DESTINATION ${ICONS_INSTALL_DESTINATION}/96x96/apps/ RENAME ${NCPROJECT_NAME}.png COMPONENT data)
	endif()
	if(EXISTS ${NCPROJECT_ICONS_DIR}/icon72.png)
		install(FILES ${NCPROJECT_ICONS_DIR}/icon72.png DESTINATION ${ICONS_INSTALL_DESTINATION}/72x72/apps/ RENAME ${NCPROJECT_NAME}.png COMPONENT data)
	endif()
	if(EXISTS ${NCPROJECT_ICONS_DIR}/icon48.png)
		install(FILES ${NCPROJECT_ICONS_DIR}/icon48.png DESTINATION ${ICONS_INSTALL_DESTINATION}/48x48/apps/ RENAME ${NCPROJECT_NAME}.png COMPONENT data)
	endif()
