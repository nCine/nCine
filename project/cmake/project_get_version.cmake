...
if(GIT_EXECUTABLE AND IS_DIRECTORY ${CMAKE_SOURCE_DIR}/.git)
	...
	if(GIT_FAIL)
		...
		list(GET GIT_LAST_COMMIT_DATE_LIST 0 NCPROJECT_VERSION_YEAR)
		list(GET GIT_LAST_COMMIT_DATE_LIST 1 NCPROJECT_VERSION_MONTH)
		list(GET GIT_LAST_COMMIT_DATE_LIST 2 NCPROJECT_VERSION_DAY)
		if(GIT_NO_TAG)
			set(NCPROJECT_VERSION_MAJOR ${NCPROJECT_VERSION_YEAR})
			set(NCPROJECT_VERSION_MINOR ${NCPROJECT_VERSION_MONTH})
...
if(GIT_NO_VERSION)
	set(GIT_NO_TAG TRUE)
	string(TIMESTAMP NCPROJECT_VERSION_YEAR "%Y")
	string(TIMESTAMP NCPROJECT_VERSION_MONTH "%m")
	string(TIMESTAMP NCPROJECT_VERSION_DAY "%d")
	set(NCPROJECT_VERSION_MAJOR ${NCPROJECT_VERSION_YEAR})
	set(NCPROJECT_VERSION_MINOR ${NCPROJECT_VERSION_MONTH})
	set(NCPROJECT_VERSION_PATCH ${NCPROJECT_VERSION_DAY})
endif()
