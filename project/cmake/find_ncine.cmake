if(NOT DEFINED nCine_DIR)
	if(DEFINED ENV{NCINE_DIR} AND IS_DIRECTORY $ENV{NCINE_DIR})
		list(APPEND CMAKE_PREFIX_PATH "$ENV{NCINE_DIR}")
	elseif(MSVC)
		get_filename_component(HKEY_LOCAL_MACHINE_SOFTWARE_NCINE "[HKEY_LOCAL_MACHINE\\SOFTWARE\\nCine]" ABSOLUTE)
		if(HKEY_LOCAL_MACHINE_SOFTWARE_NCINE AND IS_DIRECTORY "${HKEY_LOCAL_MACHINE_SOFTWARE_NCINE}")
			if(EXISTS "${HKEY_LOCAL_MACHINE_SOFTWARE_NCINE}/lib/cmake/nCine/nCineConfig.cmake")
				list(APPEND CMAKE_PREFIX_PATH "${HKEY_LOCAL_MACHINE_SOFTWARE_NCINE}")
			endif()
		endif()
	endif()
endif()
...
if(EXISTS ${NCINE_CONFIG_H})
	...
	foreach(NCINE_CONFIG_STRING ${NCINE_CONFIG_STRINGS})
		...
		elseif(NCINE_CONFIG_STRING STREQUAL "#define NCINE_WITH_QT6 1")
			set(NCINE_WITH_QT6 ON)
			message(STATUS "NCINE_WITH_QT6: " ${NCINE_WITH_QT6})
		...
		elseif(NCINE_CONFIG_STRING STREQUAL "#define NCINE_WITH_QOI 1")
			set(NCINE_WITH_QOI ON)
			message(STATUS "NCINE_WITH_QOI: " ${NCINE_WITH_QOI})
