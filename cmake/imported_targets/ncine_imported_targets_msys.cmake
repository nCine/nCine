if(MINGW OR MSYS)
	...
	if(NOT CMAKE_SKIP_RPATH AND NOT CMAKE_SKIP_INSTALL_RPATH)
		...
		set(EXTERNAL_MSYS_DIR "${PARENT_SOURCE_DIR}/nCine-external")
		if(NOT IS_DIRECTORY ${EXTERNAL_MSYS_DIR})
			message(FATAL_ERROR "nCine external MSYS libraries directory not found at: ${EXTERNAL_MSYS_DIR}")
		else()
			message(STATUS "nCine external MSYS libraries directory: ${EXTERNAL_MSYS_DIR}")
		endif()
		file(GLOB MSYS_DLL_FILES ${EXTERNAL_MSYS_DIR}/bin/*.dll)
	...
	if(SDL3_FOUND)
		foreach(LIBRARY ${SDL3_LIBRARY})
			string(REGEX MATCH "\.a$" FOUND_STATIC_LIB ${LIBRARY})
			if(NOT FOUND_STATIC_LIB STREQUAL "")
				set(SDL3_IMPORT_LIBRARY ${LIBRARY})
				break()
			endif()
		endforeach()
	
		set_msys_dll(SDL3 SDL3)
		add_library(SDL3::SDL3 SHARED IMPORTED)
		set_target_properties(SDL3::SDL3 PROPERTIES
			IMPORTED_IMPLIB ${SDL3_IMPORT_LIBRARY}
			IMPORTED_LOCATION ${SDL3_DLL_LIBRARY}
