if(NCINE_WITH_NUKLEAR)
	...
	elseif(SDL3_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "SDL3")
		...
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/NuklearSdl3Input.cpp)
	elseif(SDL2_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "SDL2")
		list(APPEND PRIVATE_HEADERS ${NCINE_ROOT}/src/include/NuklearSdlInput.h)
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/NuklearSdl2Input.cpp)
	elseif((Qt6_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "QT6") OR
			(Qt5_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "QT5"))
		list(APPEND PRIVATE_HEADERS ${NCINE_ROOT}/src/include/NuklearQtInput.h)
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/NuklearQtInput.cpp)
	elseif(ANDROID)
