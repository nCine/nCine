if(NCINE_WITH_IMGUI)
	...
	elseif(SDL3_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "SDL3")
		...
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/ImGuiSdl3Input.cpp)
	elseif(SDL2_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "SDL2")
		list(APPEND PRIVATE_HEADERS ${NCINE_ROOT}/src/include/ImGuiSdlInput.h)
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/ImGuiSdl2Input.cpp)
	elseif((Qt6_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "QT6") OR
			(Qt5_FOUND AND NCINE_PREFERRED_BACKEND STREQUAL "QT5"))
		list(APPEND PRIVATE_HEADERS ${NCINE_ROOT}/src/include/ImGuiQtInput.h)
		list(APPEND SOURCES ${NCINE_ROOT}/src/input/ImGuiQtInput.cpp)
	elseif(ANDROID)
