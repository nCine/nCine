...
if(GIT_EXECUTABLE AND IS_DIRECTORY ${CMAKE_SOURCE_DIR}/.git)
	...
	if(GIT_FAIL)
		...
		list(GET GIT_LAST_COMMIT_DATE_LIST 0 NCINE_VERSION_YEAR)
		list(GET GIT_LAST_COMMIT_DATE_LIST 1 NCINE_VERSION_MONTH)
		list(GET GIT_LAST_COMMIT_DATE_LIST 2 NCINE_VERSION_DAY)
		if(GIT_NO_TAG)
			set(NCINE_VERSION_MAJOR ${NCINE_VERSION_YEAR})
			set(NCINE_VERSION_MINOR ${NCINE_VERSION_MONTH})
...
if(GIT_NO_VERSION)
	set(GIT_NO_TAG TRUE)
	string(TIMESTAMP NCINE_VERSION_YEAR "%Y")
	string(TIMESTAMP NCINE_VERSION_MONTH "%m")
	string(TIMESTAMP NCINE_VERSION_DAY "%d")
	set(NCINE_VERSION_MAJOR ${NCINE_VERSION_YEAR})
	set(NCINE_VERSION_MINOR ${NCINE_VERSION_MONTH})
	set(NCINE_VERSION_PATCH ${NCINE_VERSION_DAY})
endif()
