...
set_property(CACHE NCINE_PREFERRED_BACKEND PROPERTY STRINGS "GLFW;SDL3;SDL2;QT6;QT5")
...
if(NCINE_WITH_THREADS)
	option(NCINE_WITH_JOBSYSTEM "Enable support for the job system" ON)
endif()
...
option(NCINE_WITH_PNG "Enable loading and saving of PNG image files" ON)
option(NCINE_WITH_WEBP "Enable loading and saving of WebP image files" ON)
option(NCINE_WITH_QOI "Enable loading and saving of QOI image files" OFF)
...
if(NCINE_USING_OPTIONS_PRESETS)
	...
	if(DEFINED NCINE_UNDEFINED_SANITIZER)
		set(NCINE_UNDEFINED_SANITIZER OFF)
	endif()
	if(DEFINED NCINE_THREAD_SANITIZER)
		set(NCINE_THREAD_SANITIZER OFF)
	endif()
