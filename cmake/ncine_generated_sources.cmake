...
if(NCINE_WITH_SCENEGRAPH)
	...
	if(NCINE_WITH_IMGUI OR NCINE_WITH_NUKLEAR)
		set(SHADER_FILES_GLOB_EXPRESSIONS "${NCINE_SRC_SHADERS_DIR}/imgui*.glsl")
	endif()
	if(NOT NCINE_DYNAMIC_LIBRARY)
		list(APPEND SHADER_FILES_GLOB_EXPRESSIONS "${NCINE_SRC_SHADERS_DIR}/vcolor*.glsl" "${NCINE_SRC_SHADERS_DIR}/texture*.glsl")
	endif()
endif()
foreach(GLOB_EXPRESSION ${SHADER_FILES_GLOB_EXPRESSIONS})
	file(GLOB SHADER_FILES_PARTIAL RELATIVE "${CMAKE_SOURCE_DIR}/${NCINE_SRC_SHADERS_DIR}/" ${GLOB_EXPRESSION})
	list(APPEND NCINE_SHADER_FILE_LIST ${SHADER_FILES_PARTIAL})
endforeach()
...
if(NCINE_EMBED_SHADERS)
	...
	foreach(SHADER_FILE_RELPATH ${NCINE_SHADER_FILE_LIST})
		set(SHADER_FILE "${CMAKE_SOURCE_DIR}/${NCINE_SRC_SHADERS_DIR}/${SHADER_FILE_RELPATH}")
...
BEGIN\n\
    ...
    BEGIN\n\
        ...
        BEGIN\n\
            ...
            VALUE \"LegalCopyright\", \"Copyright ©2011-2026 Angelo Theodorou\\0\"\n\
#ifdef NCINE_DEBUG\n\
